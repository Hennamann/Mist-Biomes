...
public class BiomeMistMesa extends Biome implements IBiomeMist {
    ...
    public BiomeMistMesa() {
        super(new BiomeProperties("Mist Mesa").setTemperature(2.0F).setRainfall(0.0F).setRainDisabled());
